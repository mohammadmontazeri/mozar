...
<div class="product-deails-area">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="zoomWrapper">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <img src="<?php echo upload_img_url($product['image']) ;?>" alt="big-1">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="add-to-cart-qty">
                        <div class="cart-qty-button">
                            <a style="padding: 5px;background-color: #aaa;color: #fff;border-radius: 2.5px;font-family:'main'"
                               href="index.php?c=order&a=add&id=<?php echo $product['id']; ?>">افزودن به سبد خرید</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php
       ...
       <div class="container">
           <div class="row">
               <div class="alert alert-danger" role="alert">
                   برای مشاهده نظرات محصول ابتدا باید وارد سایت شوید
               </div>
           </div>
       </div>
        <?php
